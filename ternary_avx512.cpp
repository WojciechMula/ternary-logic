...
namespace ternarylogic {
    ...
    namespace avx512raw {
        ...
        template<unsigned k> __m512i ternary(const __m512i A, const __m512i B, const __m512i C) {
    ...
    namespace avx512 {
        ...
        template<unsigned k> __m512i ternary(const __m512i, const __m512i, const __m512i) {
            static_assert(k < 256, "Unspecified ternary function");
            return _mm512_setzero_si512();
        }

        // code=0x00, function=0, lowered=0, set=intel
        template<> __m512i ternary<0x00>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c0 = _mm512_setzero_si512();
            return c0;
        }
        // code=0x01, function=(A nor (B or C)), lowered=((A or (B or C)) xor 1), set=intel
        template<> __m512i ternary<0x01>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
            return t2;
        }
        // code=0x02, function=(C and (B nor A)), lowered=((B or A) notand C), set=intel
        template<> __m512i ternary<0x02>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x03>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
        ...
        template<> __m512i ternary<0x04>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(t0, B);
            return t1;
        }
        // code=0x05, function=(C nor A), lowered=((C or A) xor 1), set=intel
        template<> __m512i ternary<0x05>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x06>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(A, t0);
            return t1;
        }
        // code=0x07, function=(A nor (B and C)), lowered=((A or (B and C)) xor 1), set=intel
        template<> __m512i ternary<0x07>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x08>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i t1 = _mm512_and_si512(t0, C);
            return t1;
        }
        // code=0x09, function=(A nor (B xor C)), lowered=((A or (B xor C)) xor 1), set=intel
        template<> __m512i ternary<0x09>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x0a>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x0b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
        ...
        template<> __m512i ternary<0x0c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            return t0;
        }
        // code=0x0d, function=(not (A) and (B or (C xor 1))), lowered=(A notand (B or (C xor 1))), set=automat
        template<> __m512i ternary<0x0d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
        ...
        template<> __m512i ternary<0x0e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(A, t0);
            return t1;
        }
        // code=0x0f, function=not (A), lowered=(A xor 1), set=intel
        template<> __m512i ternary<0x0f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            return t0;
        }
        // code=0x10, function=(A and (B nor C)), lowered=((B or C) notand A), set=intel
        template<> __m512i ternary<0x10>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(t0, A);
            return t1;
        }
        // code=0x11, function=(C nor B), lowered=((C or B) xor 1), set=intel
        template<> __m512i ternary<0x11>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x12>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x13>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x14>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i t1 = _mm512_andnot_si512(C, t0);
            return t1;
        }
        // code=0x15, function=(C nor (B and A)), lowered=((C or (B and A)) xor 1), set=intel
        template<> __m512i ternary<0x15>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x16>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(t0, A);
            const __m512i t2 = _mm512_xor_si512(B, C);
            const __m512i t3 = _mm512_andnot_si512(A, t2);
            const __m512i t4 = _mm512_or_si512(t1, t3);
            return t4;
        }
        // code=0x17, function=((B nor C) or (not (A) and (B xor C))), lowered=(((B or C) xor 1) or (A notand (B xor C))), set=optimized
        template<> __m512i ternary<0x17>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_xor_si512(B, C);
        ...
        template<> __m512i ternary<0x18>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        }
        // code=0x19, function=(not ((A and B)) and (B xor (C xor 1))), lowered=((A and B) notand (B xor (C xor 1))), set=automat
        template<> __m512i ternary<0x19>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(B, t1);
            const __m512i t3 = _mm512_andnot_si512(t0, t2);
            return t3;
        }
        // code=0x1a, function=(not ((A and B)) and (A xor C)), lowered=((A and B) notand (A xor C)), set=automat
        template<> __m512i ternary<0x1a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
        ...
        template<> __m512i ternary<0x1c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        }
        ...
        template<> __m512i ternary<0x1e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, t0);
            return t1;
        }
        // code=0x1f, function=(A nand (B or C)), lowered=((A and (B or C)) xor 1), set=intel
        template<> __m512i ternary<0x1f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
        ...
        template<> __m512i ternary<0x20>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_and_si512(t0, C);
            return t1;
        }
        // code=0x21, function=(B nor (A xor C)), lowered=((B or (A xor C)) xor 1), set=intel
        template<> __m512i ternary<0x21>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_or_si512(B, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x22>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x23>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            const __m512i t1 = _mm512_or_si512(t0, C);
            const __m512i t2 = _mm512_andnot_si512(B, t1);
        ...
        template<> __m512i ternary<0x24>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        }
        // code=0x25, function=(not ((A and B)) and (A xor (C xor 1))), lowered=((A and B) notand (A xor (C xor 1))), set=automat
        template<> __m512i ternary<0x25>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
            const __m512i t3 = _mm512_andnot_si512(t0, t2);
            return t3;
        }
        // code=0x26, function=(not ((A and B)) and (B xor C)), lowered=((A and B) notand (B xor C)), set=automat
        template<> __m512i ternary<0x26>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x28>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x2a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i t1 = _mm512_andnot_si512(t0, C);
            return t1;
        }
        ...
        template<> __m512i ternary<0x2c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x2d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            const __m512i t1 = _mm512_or_si512(B, t0);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0x2e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_and_si512(A, B);
            const __m512i t2 = _mm512_xor_si512(t0, t1);
            return t2;
        }
        // code=0x2f, function=((not (B) and C) or (A xor 1)), lowered=((B notand C) or (A xor 1)), set=automat
        template<> __m512i ternary<0x2f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0x30, function=(A and not (B)), lowered=(B notand A), set=intel
        template<> __m512i ternary<0x30>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            return t0;
        }
        // code=0x31, function=(not (B) and (A or (C xor 1))), lowered=(B notand (A or (C xor 1))), set=automat
        template<> __m512i ternary<0x31>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            const __m512i t1 = _mm512_or_si512(A, t0);
            const __m512i t2 = _mm512_andnot_si512(B, t1);
        ...
        template<> __m512i ternary<0x32>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(B, t0);
            return t1;
        }
        // code=0x33, function=not (B), lowered=(B xor 1), set=intel
        template<> __m512i ternary<0x33>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            return t0;
        }
        // code=0x34, function=(not ((B and C)) and (A xor B)), lowered=((B and C) notand (A xor B)), set=automat
        template<> __m512i ternary<0x34>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x36>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, t0);
            return t1;
        }
        // code=0x37, function=(B nand (A or C)), lowered=((B and (A or C)) xor 1), set=intel
        template<> __m512i ternary<0x37>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
        ...
        template<> __m512i ternary<0x38>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x39>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            const __m512i t1 = _mm512_or_si512(A, t0);
            const __m512i t2 = _mm512_xor_si512(B, t1);
        ...
        template<> __m512i ternary<0x3a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_andnot_si512(A, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0x3b, function=((not (A) and C) or (B xor 1)), lowered=((A notand C) or (B xor 1)), set=automat
        template<> __m512i ternary<0x3b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x3c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            return t0;
        }
        // code=0x3d, function=((A xor B) or ((A or C) xor 1)), lowered=((A xor B) or ((A or C) xor 1)), set=automat
        template<> __m512i ternary<0x3d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i t1 = _mm512_or_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
            return t3;
        ...
        template<> __m512i ternary<0x3e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x3f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            return t1;
        ...
        template<> __m512i ternary<0x40>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i t1 = _mm512_and_si512(t0, B);
            return t1;
        }
        // code=0x41, function=(C nor (B xor A)), lowered=((C or (B xor A)) xor 1), set=intel
        template<> __m512i ternary<0x41>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            const __m512i t1 = _mm512_or_si512(C, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x42>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x43>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0x44>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x45>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
        ...
        template<> __m512i ternary<0x46>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x48>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_and_si512(B, t0);
            return t1;
        }
        ...
        template<> __m512i ternary<0x4a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x4b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            const __m512i t1 = _mm512_or_si512(t0, C);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0x4c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(t0, B);
            return t1;
        }
        ...
        template<> __m512i ternary<0x4e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(C, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0x4f, function=((not (C) and B) or (A xor 1)), lowered=((C notand B) or (A xor 1)), set=automat
        template<> __m512i ternary<0x4f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x50>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            return t0;
        }
        // code=0x51, function=(not (C) and (A or (B xor 1))), lowered=(C notand (A or (B xor 1))), set=automat
        template<> __m512i ternary<0x51>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            const __m512i t1 = _mm512_or_si512(A, t0);
            const __m512i t2 = _mm512_andnot_si512(C, t1);
        ...
        template<> __m512i ternary<0x52>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x54>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, B);
            const __m512i t1 = _mm512_andnot_si512(C, t0);
            return t1;
        }
        // code=0x55, function=not (C), lowered=(C xor 1), set=intel
        template<> __m512i ternary<0x55>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            return t0;
        }
        // code=0x56, function=(C xor (B or A)), lowered=(C xor (B or A)), set=intel
        template<> __m512i ternary<0x56>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(C, t0);
            return t1;
        }
        // code=0x57, function=(C nand (B or A)), lowered=((C and (B or A)) xor 1), set=intel
        template<> __m512i ternary<0x57>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, A);
            const __m512i t1 = _mm512_and_si512(C, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x58>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x59>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            const __m512i t1 = _mm512_or_si512(A, t0);
            const __m512i t2 = _mm512_xor_si512(C, t1);
            return t2;
        }
        // code=0x5a, function=(C xor A), lowered=(C xor A), set=intel
        template<> __m512i ternary<0x5a>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x5b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_or_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
            return t3;
        ...
        template<> __m512i ternary<0x5c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i t1 = _mm512_andnot_si512(A, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0x5d, function=((not (A) and B) or (C xor 1)), lowered=((A notand B) or (C xor 1)), set=automat
        template<> __m512i ternary<0x5d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x5e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x5f>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x60>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_and_si512(A, t0);
            return t1;
        }
        ...
        template<> __m512i ternary<0x62>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x63>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            const __m512i t1 = _mm512_or_si512(t0, C);
            const __m512i t2 = _mm512_xor_si512(B, t1);
        ...
        template<> __m512i ternary<0x64>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_and_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x65>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            const __m512i t1 = _mm512_or_si512(t0, B);
            const __m512i t2 = _mm512_xor_si512(C, t1);
        ...
        template<> __m512i ternary<0x66>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x67>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x68>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_and_si512(A, t0);
        ...
        template<> __m512i ternary<0x69>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x6a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(C, t0);
            return t1;
        }
        // code=0x6b, function=((not (A) and C) or ((A xor 1) xor (B xor C))), lowered=((A notand C) or ((A xor 1) xor (B xor C))), set=automat
        template<> __m512i ternary<0x6b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_xor_si512(B, C);
            const __m512i t3 = _mm512_xor_si512(t1, t2);
            const __m512i t4 = _mm512_or_si512(t0, t3);
            return t4;
        }
        // code=0x6c, function=(B xor (A and C)), lowered=(B xor (A and C)), set=intel
        template<> __m512i ternary<0x6c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, t0);
            return t1;
        }
        // code=0x6d, function=((not (A) and B) or ((A xor 1) xor (B xor C))), lowered=((A notand B) or ((A xor 1) xor (B xor C))), set=automat
        template<> __m512i ternary<0x6d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_xor_si512(B, C);
        ...
        template<> __m512i ternary<0x6e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x6f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x70>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(t0, A);
            return t1;
        }
        // code=0x71, function=((B nor C) or (A and (B xor C))), lowered=(((B or C) xor 1) or (A and (B xor C))), set=optimized
        template<> __m512i ternary<0x71>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_xor_si512(B, C);
            const __m512i t3 = _mm512_and_si512(A, t2);
            const __m512i t4 = _mm512_or_si512(t1, t3);
            return t4;
        }
        // code=0x72, function=(C ? not (B) : A), lowered=((B notand C) or (C notand A)), set=intel
        template<> __m512i ternary<0x72>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(C, A);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0x73, function=((not (C) and A) or (B xor 1)), lowered=((C notand A) or (B xor 1)), set=automat
        template<> __m512i ternary<0x73>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x74>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i t1 = _mm512_andnot_si512(B, A);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0x75, function=((not (B) and A) or (C xor 1)), lowered=((B notand A) or (C xor 1)), set=automat
        template<> __m512i ternary<0x75>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x76>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x77>(const __m512i A, const __m512i B, const __m512i C) {
        ...
        template<> __m512i ternary<0x78>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, t0);
            return t1;
        }
        // code=0x79, function=((not (B) and A) or ((B xor 1) xor (A xor C))), lowered=((B notand A) or ((B xor 1) xor (A xor C))), set=automat
        template<> __m512i ternary<0x79>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, C);
            const __m512i t3 = _mm512_xor_si512(t1, t2);
            const __m512i t4 = _mm512_or_si512(t0, t3);
            return t4;
        }
        // code=0x7a, function=((not (B) and A) or (A xor C)), lowered=((B notand A) or (A xor C)), set=automat
        template<> __m512i ternary<0x7a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x7b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x7c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x7d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x7e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x7f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_and_si512(t0, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x80>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_and_si512(A, t0);
            return t1;
        }
        // code=0x81, function=(not ((A xor C)) and (A xor (B xor 1))), lowered=((A xor C) notand (A xor (B xor 1))), set=automat
        template<> __m512i ternary<0x81>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0x82>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            const __m512i t1 = _mm512_andnot_si512(t0, C);
            return t1;
        }
        // code=0x83, function=(not ((A xor B)) and ((A xor 1) or C)), lowered=((A xor B) notand ((A xor 1) or C)), set=automat
        template<> __m512i ternary<0x83>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
        ...
        template<> __m512i ternary<0x84>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(t0, B);
            return t1;
        }
        // code=0x85, function=(not ((A xor C)) and (B or (C xor 1))), lowered=((A xor C) notand (B or (C xor 1))), set=automat
        template<> __m512i ternary<0x85>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_or_si512(B, t1);
            const __m512i t3 = _mm512_andnot_si512(t0, t2);
            return t3;
        }
        // code=0x86, function=((B or C) and (C xor (A xor B))), lowered=((B or C) and (C xor (A xor B))), set=automat
        template<> __m512i ternary<0x86>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_xor_si512(C, t1);
            const __m512i t3 = _mm512_and_si512(t0, t2);
            return t3;
        }
        // code=0x87, function=(A xnor (B and C)), lowered=((A xor (B and C)) xor 1), set=intel
        template<> __m512i ternary<0x87>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x88>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(C, B);
            return t0;
        }
        // code=0x89, function=(not ((B xor C)) and ((A xor 1) or B)), lowered=((B xor C) notand ((A xor 1) or B)), set=automat
        template<> __m512i ternary<0x89>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
        ...
        template<> __m512i ternary<0x8a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_andnot_si512(t0, C);
            return t1;
        }
        // code=0x8b, function=(B ? C : not (A)), lowered=((B and C) or (B notand (A xor 1))), set=intel
        template<> __m512i ternary<0x8b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_andnot_si512(B, t1);
        ...
        template<> __m512i ternary<0x8c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i t1 = _mm512_andnot_si512(t0, B);
            return t1;
        }
        // code=0x8d, function=(C ? B : not (A)), lowered=((C and B) or (C notand (A xor 1))), set=intel
        template<> __m512i ternary<0x8d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(C, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_andnot_si512(C, t1);
        ...
        template<> __m512i ternary<0x8e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_andnot_si512(A, t1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
        ...
        template<> __m512i ternary<0x8f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(A, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0x90>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(t0, A);
            return t1;
        }
        // code=0x91, function=(not ((B xor C)) and (A or (B xor 1))), lowered=((B xor C) notand (A or (B xor 1))), set=automat
        template<> __m512i ternary<0x91>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_or_si512(A, t1);
            const __m512i t3 = _mm512_andnot_si512(t0, t2);
            return t3;
        }
        // code=0x92, function=((A or C) and (C xor (A xor B))), lowered=((A or C) and (C xor (A xor B))), set=automat
        template<> __m512i ternary<0x92>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_xor_si512(C, t1);
            const __m512i t3 = _mm512_and_si512(t0, t2);
        ...
        template<> __m512i ternary<0x93>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x94>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_xor_si512(B, t1);
            const __m512i t3 = _mm512_and_si512(t0, t2);
        ...
        template<> __m512i ternary<0x95>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(C, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0x96>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, t0);
            return t1;
        }
        ...
        template<> __m512i ternary<0x98>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, B);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0x99>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(C, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            return t1;
        ...
        template<> __m512i ternary<0x9a>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(t0, C);
            return t1;
        }
        // code=0x9b, function=((not (A) and C) or (B xor (C xor 1))), lowered=((A notand C) or (B xor (C xor 1))), set=automat
        template<> __m512i ternary<0x9b>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(B, t1);
        ...
        template<> __m512i ternary<0x9c>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i t1 = _mm512_xor_si512(t0, B);
            return t1;
        }
        // code=0x9d, function=((not (A) and B) or (B xor (C xor 1))), lowered=((A notand B) or (B xor (C xor 1))), set=automat
        template<> __m512i ternary<0x9d>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(B, t1);
        ...
        template<> __m512i ternary<0x9e>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_xor_si512(C, t1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
        ...
        template<> __m512i ternary<0x9f>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_and_si512(A, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0xa0>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(C, A);
            return t0;
        }
        // code=0xa1, function=(not ((A xor C)) and (A or (B xor 1))), lowered=((A xor C) notand (A or (B xor 1))), set=automat
        template<> __m512i ternary<0xa1>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xa2>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i t1 = _mm512_andnot_si512(t0, C);
            return t1;
        }
        // code=0xa3, function=(A ? C : not (B)), lowered=((A and C) or (A notand (B xor 1))), set=intel
        template<> __m512i ternary<0xa3>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_andnot_si512(A, t1);
        ...
        template<> __m512i ternary<0xa4>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_or_si512(A, B);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xa5>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(C, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            return t1;
        ...
        template<> __m512i ternary<0xa6>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(t0, C);
            return t1;
        }
        // code=0xa7, function=((not (B) and C) or (A xor (C xor 1))), lowered=((B notand C) or (A xor (C xor 1))), set=automat
        template<> __m512i ternary<0xa7>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xa8>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, B);
            const __m512i t1 = _mm512_and_si512(C, t0);
            return t1;
        }
        // code=0xa9, function=(C xnor (B or A)), lowered=((C xor (B or A)) xor 1), set=intel
        template<> __m512i ternary<0xa9>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, A);
            const __m512i t1 = _mm512_xor_si512(C, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0xaa>(const __m512i A, const __m512i B, const __m512i C) {
            return C;
        }
        // code=0xab, function=(C or (B nor A)), lowered=(C or ((B or A) xor 1)), set=intel
        template<> __m512i ternary<0xab>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(C, t1);
            return t2;
        }
        // code=0xac, function=(A ? C : B), lowered=((A and C) or (A notand B)), set=intel
        template<> __m512i ternary<0xac>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(A, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xad>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xae>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, B);
            const __m512i t1 = _mm512_or_si512(t0, C);
            return t1;
        }
        // code=0xaf, function=(C or not (A)), lowered=(C or (A xor 1)), set=intel
        template<> __m512i ternary<0xaf>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            const __m512i t1 = _mm512_or_si512(C, t0);
            return t1;
        ...
        template<> __m512i ternary<0xb0>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i t1 = _mm512_andnot_si512(t0, A);
            return t1;
        }
        // code=0xb1, function=(C ? A : not (B)), lowered=((C and A) or (C notand (B xor 1))), set=intel
        template<> __m512i ternary<0xb1>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(C, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_andnot_si512(C, t1);
        ...
        template<> __m512i ternary<0xb2>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_and_si512(B, t0);
            const __m512i t2 = _mm512_or_si512(A, C);
            const __m512i t3 = _mm512_andnot_si512(B, t2);
            const __m512i t4 = _mm512_or_si512(t1, t3);
            return t4;
        }
        // code=0xb3, function=((A and C) or (B xor 1)), lowered=((A and C) or (B xor 1)), set=automat
        template<> __m512i ternary<0xb3>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0xb4>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i t1 = _mm512_xor_si512(t0, A);
            return t1;
        }
        // code=0xb5, function=((not (B) and A) or (A xor (C xor 1))), lowered=((B notand A) or (A xor (C xor 1))), set=automat
        template<> __m512i ternary<0xb5>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xb6>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_xor_si512(C, t1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
        ...
        template<> __m512i ternary<0xb7>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_and_si512(B, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0xb8>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(B, A);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xb9>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(B, t1);
        ...
        template<> __m512i ternary<0xba>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, A);
            const __m512i t1 = _mm512_or_si512(t0, C);
            return t1;
        }
        // code=0xbb, function=(C or not (B)), lowered=(C or (B xor 1)), set=intel
        template<> __m512i ternary<0xbb>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            const __m512i t1 = _mm512_or_si512(C, t0);
            return t1;
        ...
        template<> __m512i ternary<0xbc>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(A, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xbd>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xbe>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            const __m512i t1 = _mm512_or_si512(C, t0);
            return t1;
        }
        // code=0xbf, function=(C or (B nand A)), lowered=(C or ((B and A) xor 1)), set=intel
        template<> __m512i ternary<0xbf>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(C, t1);
        ...
        template<> __m512i ternary<0xc0>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            return t0;
        }
        // code=0xc1, function=(not ((A xor B)) and (A or (C xor 1))), lowered=((A xor B) notand (A or (C xor 1))), set=automat
        template<> __m512i ternary<0xc1>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xc2>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, B);
            const __m512i t1 = _mm512_or_si512(A, C);
            const __m512i t2 = _mm512_andnot_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xc3>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            return t1;
        ...
        template<> __m512i ternary<0xc4>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i t1 = _mm512_andnot_si512(t0, B);
            return t1;
        }
        // code=0xc5, function=(A ? B : not (C)), lowered=((A and B) or (A notand (C xor 1))), set=intel
        template<> __m512i ternary<0xc5>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_andnot_si512(A, t1);
        ...
        template<> __m512i ternary<0xc6>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(t0, B);
            return t1;
        }
        // code=0xc7, function=((not (C) and B) or (A xor (B xor 1))), lowered=((C notand B) or (A xor (B xor 1))), set=automat
        template<> __m512i ternary<0xc7>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xc8>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_and_si512(B, t0);
            return t1;
        }
        // code=0xc9, function=(B xnor (A or C)), lowered=((B xor (A or C)) xor 1), set=intel
        template<> __m512i ternary<0xc9>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i t1 = _mm512_xor_si512(B, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0xca>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_andnot_si512(A, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xcb>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xcc>(const __m512i A, const __m512i B, const __m512i C) {
            return B;
        }
        // code=0xcd, function=(B or (A nor C)), lowered=(B or ((A or C) xor 1)), set=intel
        template<> __m512i ternary<0xcd>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(B, t1);
        ...
        template<> __m512i ternary<0xce>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(A, C);
            const __m512i t1 = _mm512_or_si512(t0, B);
            return t1;
        }
        // code=0xcf, function=(B or not (A)), lowered=(B or (A xor 1)), set=intel
        template<> __m512i ternary<0xcf>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            const __m512i t1 = _mm512_or_si512(B, t0);
            return t1;
        ...
        template<> __m512i ternary<0xd0>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, C);
            const __m512i t1 = _mm512_andnot_si512(t0, A);
            return t1;
        }
        // code=0xd1, function=((B nor C) or (A and B)), lowered=(((B or C) xor 1) or (A and B)), set=optimized
        template<> __m512i ternary<0xd1>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_and_si512(A, B);
            const __m512i t3 = _mm512_or_si512(t1, t2);
            return t3;
        }
        // code=0xd2, function=((not (B) and C) xor A), lowered=((B notand C) xor A), set=automat
        template<> __m512i ternary<0xd2>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(t0, A);
            return t1;
        }
        // code=0xd3, function=((not (C) and A) or (A xor (B xor 1))), lowered=((C notand A) or (A xor (B xor 1))), set=automat
        template<> __m512i ternary<0xd3>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xd4>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_andnot_si512(t1, A);
            const __m512i t3 = _mm512_or_si512(t0, t2);
            return t3;
        }
        // code=0xd5, function=((A and B) or (C xor 1)), lowered=((A and B) or (C xor 1)), set=automat
        template<> __m512i ternary<0xd5>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_or_si512(t0, t1);
        ...
        template<> __m512i ternary<0xd6>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_xor_si512(B, t1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
        ...
        template<> __m512i ternary<0xd7>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            const __m512i t1 = _mm512_and_si512(C, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0xd8>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(C, B);
            const __m512i t1 = _mm512_andnot_si512(C, A);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xd9>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(B, t1);
        ...
        template<> __m512i ternary<0xda>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(A, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xdb>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xdc>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, A);
            const __m512i t1 = _mm512_or_si512(t0, B);
            return t1;
        }
        // code=0xdd, function=(B or not (C)), lowered=(B or (C xor 1)), set=intel
        template<> __m512i ternary<0xdd>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            const __m512i t1 = _mm512_or_si512(B, t0);
            return t1;
        ...
        template<> __m512i ternary<0xde>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i t1 = _mm512_or_si512(B, t0);
            return t1;
        }
        // code=0xdf, function=(B or (A nand C)), lowered=(B or ((A and C) xor 1)), set=intel
        template<> __m512i ternary<0xdf>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(B, t1);
        ...
        template<> __m512i ternary<0xe0>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_and_si512(A, t0);
            return t1;
        }
        // code=0xe1, function=(A xnor (B or C)), lowered=((A xor (B or C)) xor 1), set=intel
        template<> __m512i ternary<0xe1>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(A, t0);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t2 = _mm512_xor_si512(t1, c1);
        ...
        template<> __m512i ternary<0xe2>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i t1 = _mm512_andnot_si512(B, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        }
        // code=0xe3, function=((A and C) or (A xor (B xor 1))), lowered=((A and C) or (A xor (B xor 1))), set=automat
        template<> __m512i ternary<0xe3>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xe4>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(C, A);
            const __m512i t1 = _mm512_andnot_si512(C, B);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xe5>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xe6>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_or_si512(t0, t1);
            return t2;
        ...
        template<> __m512i ternary<0xe7>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(B, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
        ...
        template<> __m512i ternary<0xe8>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_xor_si512(B, C);
            const __m512i t2 = _mm512_and_si512(A, t1);
            const __m512i t3 = _mm512_or_si512(t0, t2);
            return t3;
        }
        // code=0xe9, function=((A and B) or (B xor (A xor (C xor 1)))), lowered=((A and B) or (B xor (A xor (C xor 1)))), set=automat
        template<> __m512i ternary<0xe9>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, B);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(C, c1);
            const __m512i t2 = _mm512_xor_si512(A, t1);
            const __m512i t3 = _mm512_xor_si512(B, t2);
            const __m512i t4 = _mm512_or_si512(t0, t3);
            return t4;
        }
        // code=0xea, function=(C or (B and A)), lowered=(C or (B and A)), set=intel
        template<> __m512i ternary<0xea>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, A);
            const __m512i t1 = _mm512_or_si512(C, t0);
            return t1;
        }
        // code=0xeb, function=(C or (B xnor A)), lowered=(C or ((B xor A) xor 1)), set=intel
        template<> __m512i ternary<0xeb>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, A);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(C, t1);
        ...
        template<> __m512i ternary<0xec>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(A, C);
            const __m512i t1 = _mm512_or_si512(B, t0);
            return t1;
        }
        // code=0xed, function=(B or (A xnor C)), lowered=(B or ((A xor C) xor 1)), set=intel
        template<> __m512i ternary<0xed>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(A, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(B, t1);
        ...
        template<> __m512i ternary<0xee>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(C, B);
            return t0;
        }
        // code=0xef, function=(B or ((A xor 1) or C)), lowered=(B or ((A xor 1) or C)), set=automat
        template<> __m512i ternary<0xef>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(A, c1);
            const __m512i t1 = _mm512_or_si512(t0, C);
            const __m512i t2 = _mm512_or_si512(B, t1);
        ...
        template<> __m512i ternary<0xf0>(const __m512i A, const __m512i B, const __m512i C) {
            return A;
        }
        // code=0xf1, function=(A or (B nor C)), lowered=(A or ((B or C) xor 1)), set=intel
        template<> __m512i ternary<0xf1>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xf2>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(B, C);
            const __m512i t1 = _mm512_or_si512(t0, A);
            return t1;
        }
        // code=0xf3, function=(A or not (B)), lowered=(A or (B xor 1)), set=intel
        template<> __m512i ternary<0xf3>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            const __m512i t1 = _mm512_or_si512(A, t0);
            return t1;
        ...
        template<> __m512i ternary<0xf4>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_andnot_si512(C, B);
            const __m512i t1 = _mm512_or_si512(t0, A);
            return t1;
        }
        // code=0xf5, function=(A or not (C)), lowered=(A or (C xor 1)), set=intel
        template<> __m512i ternary<0xf5>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            const __m512i t1 = _mm512_or_si512(A, t0);
            return t1;
        ...
        template<> __m512i ternary<0xf6>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, t0);
            return t1;
        }
        // code=0xf7, function=(A or (B nand C)), lowered=(A or ((B and C) xor 1)), set=intel
        template<> __m512i ternary<0xf7>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xf8>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_and_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, t0);
            return t1;
        }
        // code=0xf9, function=(A or (B xnor C)), lowered=(A or ((B xor C) xor 1)), set=intel
        template<> __m512i ternary<0xf9>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_xor_si512(B, C);
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t1 = _mm512_xor_si512(t0, c1);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xfa>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(C, A);
            return t0;
        }
        // code=0xfb, function=(A or ((B xor 1) or C)), lowered=(A or ((B xor 1) or C)), set=automat
        template<> __m512i ternary<0xfb>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(B, c1);
            const __m512i t1 = _mm512_or_si512(t0, C);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xfc>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, A);
            return t0;
        }
        // code=0xfd, function=(A or (B or (C xor 1))), lowered=(A or (B or (C xor 1))), set=automat
        template<> __m512i ternary<0xfd>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            const __m512i t0 = _mm512_xor_si512(C, c1);
            const __m512i t1 = _mm512_or_si512(B, t0);
            const __m512i t2 = _mm512_or_si512(A, t1);
        ...
        template<> __m512i ternary<0xfe>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i t0 = _mm512_or_si512(B, C);
            const __m512i t1 = _mm512_or_si512(A, t0);
            return t1;
        }
        // code=0xff, function=1, lowered=1, set=intel
        template<> __m512i ternary<0xff>(const __m512i A, const __m512i B, const __m512i C) {
            const __m512i c1 = _mm512_set1_epi32(-1);
            return c1;
        }
