...
namespace ternarylogic {
    ...
    namespace neon {
        ...
        template<> int32x4_t ternary<0x01>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            ...
            const int32x4_t t2 = vmvnq_s32(t1);
            return t2;
        }
        ...
        template<> int32x4_t ternary<0x03>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vorrq_s32(B, A);
            const int32x4_t t1 = vmvnq_s32(t0);
            return t1;
        }
        ...
        // code=0x0b, function=(not (A) and (not (B) or C)), lowered=(A notand (B notor C)), set=neon
        template<> int32x4_t ternary<0x0b>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(C, B);
            const int32x4_t t1 = vbicq_s32(t0, A);
            return t1;
        }
        ...
        // code=0x0d, function=(not (A) and (not (C) or B)), lowered=(A notand (C notor B)), set=neon
        template<> int32x4_t ternary<0x0d>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(B, C);
            const int32x4_t t1 = vbicq_s32(t0, A);
            return t1;
        }
        ...
        template<> int32x4_t ternary<0x0f>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vmvnq_s32(A);
            return t0;
        }
        ...
        // code=0x17, function=((B nor C) or (not (A) and (B xor C))), lowered=((B or C) notor (A notand (B xor C))), set=optimized
        template<> int32x4_t ternary<0x17>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            ...
            const int32x4_t t3 = vornq_s32(t2, t0);
            return t3;
        }
        ...
        // code=0x19, function=(not ((A and B)) and (B xor not (C))), lowered=((A and B) notand (B xor not (C))), set=neon
        template<> int32x4_t ternary<0x19>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(A, B);
            const int32x4_t t1 = vmvnq_s32(C);
        ...
        // code=0x1b, function=((A and C) xor (not (B) or C)), lowered=((A and C) xor (B notor C)), set=neon
        template<> int32x4_t ternary<0x1b>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(A, C);
            const int32x4_t t1 = vornq_s32(C, B);
        ...
        // code=0x1d, function=((A and B) xor (not (C) or B)), lowered=((A and B) xor (C notor B)), set=neon
        template<> int32x4_t ternary<0x1d>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(A, B);
            const int32x4_t t1 = vornq_s32(B, C);
            const int32x4_t t2 = veorq_s32(t0, t1);
            return t2;
        }
        ...
        // code=0x23, function=(not (B) and (not (A) or C)), lowered=(B notand (A notor C)), set=neon
        template<> int32x4_t ternary<0x23>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(C, A);
            const int32x4_t t1 = vbicq_s32(t0, B);
            return t1;
        }
        ...
        // code=0x25, function=(not ((A and B)) and (A xor not (C))), lowered=((A and B) notand (A xor not (C))), set=neon
        ...
        // code=0x27, function=((B and C) xor (not (A) or C)), lowered=((B and C) xor (A notor C)), set=neon
        template<> int32x4_t ternary<0x27>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(B, C);
            const int32x4_t t1 = vornq_s32(C, A);
            const int32x4_t t2 = veorq_s32(t0, t1);
            return t2;
        }
        ...
        // code=0x29, function=((not (A) or C) and (not (A) xor (B xor C))), lowered=((A notor C) and (not (A) xor (B xor C))), set=neon
        template<> int32x4_t ternary<0x29>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(C, A);
            const int32x4_t t1 = vmvnq_s32(A);
            const int32x4_t t2 = veorq_s32(B, C);
            const int32x4_t t3 = veorq_s32(t1, t2);
            const int32x4_t t4 = vandq_s32(t0, t3);
            return t4;
        }
        ...
        // code=0x2b, function=((not (B) and (not (C) and A)) xor (not (B) or (not (A) and C))), lowered=((B notand (C notand A)) xor (B notor (A notand C))), set=neon
        template<> int32x4_t ternary<0x2b>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(A, C);
            const int32x4_t t1 = vbicq_s32(t0, B);
            const int32x4_t t2 = vbicq_s32(C, A);
            const int32x4_t t3 = vornq_s32(t2, B);
            const int32x4_t t4 = veorq_s32(t1, t3);
            return t4;
        }
        ...
        // code=0x2d, function=(A xor (B or not (C))), lowered=(A xor (C notor B)), set=optimized
        ...
        // code=0x2f, function=(not (A) or (not (B) and C)), lowered=(A notor (B notand C)), set=optimized
        template<> int32x4_t ternary<0x2f>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(C, B);
            const int32x4_t t1 = vornq_s32(t0, A);
            return t1;
        }
        ...
        // code=0x31, function=(not (B) and (not (C) or A)), lowered=(B notand (C notor A)), set=neon
        template<> int32x4_t ternary<0x31>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(A, C);
            const int32x4_t t1 = vbicq_s32(t0, B);
            return t1;
        }
        ...
        template<> int32x4_t ternary<0x33>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vmvnq_s32(B);
            return t0;
        }
        ...
        // code=0x35, function=((A and B) xor (not (C) or A)), lowered=((A and B) xor (C notor A)), set=neon
        template<> int32x4_t ternary<0x35>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(A, B);
            const int32x4_t t1 = vornq_s32(A, C);
            const int32x4_t t2 = veorq_s32(t0, t1);
            return t2;
        }
        ...
        // code=0x39, function=(B xor (not (C) or A)), lowered=(B xor (C notor A)), set=neon
        ...
        // code=0x3b, function=(not (B) or (not (A) and C)), lowered=(B notor (A notand C)), set=neon
        template<> int32x4_t ternary<0x3b>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(C, A);
            const int32x4_t t1 = vornq_s32(t0, B);
            return t1;
        }
        ...
        // code=0x3d, function=((A xor B) or (A nor C)), lowered=((A or C) notor (A xor B)), set=optimized
        template<> int32x4_t ternary<0x3d>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vorrq_s32(A, C);
            const int32x4_t t1 = veorq_s32(A, B);
            const int32x4_t t2 = vornq_s32(t1, t0);
            return t2;
        }
        ...
        // code=0x43, function=(not ((A and C)) and (A xor not (B))), lowered=((A and C) notand (A xor not (B))), set=neon
        template<> int32x4_t ternary<0x43>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(A, C);
            const int32x4_t t1 = vmvnq_s32(B);
            const int32x4_t t2 = veorq_s32(A, t1);
            const int32x4_t t3 = vbicq_s32(t2, t0);
            return t3;
        }
        ...
        // code=0x45, function=(not (C) and (not (A) or B)), lowered=(C notand (A notor B)), set=neon
        template<> int32x4_t ternary<0x45>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(B, A);
            const int32x4_t t1 = vbicq_s32(t0, C);
            return t1;
        }
        ...
        // code=0x47, function=((B and C) xor (not (A) or B)), lowered=((B and C) xor (A notor B)), set=neon
        template<> int32x4_t ternary<0x47>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(B, C);
            const int32x4_t t1 = vornq_s32(B, A);
            const int32x4_t t2 = veorq_s32(t0, t1);
            return t2;
        }
        ...
        // code=0x49, function=((not (A) or B) and (not (A) xor (B xor C))), lowered=((A notor B) and (not (A) xor (B xor C))), set=neon
        ...
        // code=0x4b, function=(A xor (not (B) or C)), lowered=(A xor (B notor C)), set=optimized
        ...
        // code=0x4d, function=((not (C) and (not (B) and A)) xor (not (C) or (not (A) and B))), lowered=((C notand (B notand A)) xor (C notor (A notand B))), set=neon
        template<> int32x4_t ternary<0x4d>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(A, B);
            const int32x4_t t1 = vbicq_s32(t0, C);
            const int32x4_t t2 = vbicq_s32(B, A);
            const int32x4_t t3 = vornq_s32(t2, C);
            const int32x4_t t4 = veorq_s32(t1, t3);
            return t4;
        }
        ...
        // code=0x4f, function=(not (A) or (B and not (C))), lowered=(A notor (C notand B)), set=optimized
        ...
        // code=0x51, function=(not (C) and (not (B) or A)), lowered=(C notand (B notor A)), set=neon
        template<> int32x4_t ternary<0x51>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vornq_s32(A, B);
            const int32x4_t t1 = vbicq_s32(t0, C);
            return t1;
        }
        ...
        // code=0x53, function=((A and C) xor (not (B) or A)), lowered=((A and C) xor (B notor A)), set=neon
        template<> int32x4_t ternary<0x53>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vandq_s32(A, C);
            const int32x4_t t1 = vornq_s32(A, B);
            const int32x4_t t2 = veorq_s32(t0, t1);
            return t2;
        }
        ...
        template<> int32x4_t ternary<0x55>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vmvnq_s32(C);
            return t0;
        }
        ...
        // code=0x59, function=(C xor (not (B) or A)), lowered=(C xor (B notor A)), set=neon
        ...
        // code=0x5b, function=(not ((A or B)) or (A xor C)), lowered=((A or B) notor (A xor C)), set=neon
        ...
        // code=0x5d, function=(not (C) or (not (A) and B)), lowered=(C notor (A notand B)), set=optimized
        template<> int32x4_t ternary<0x5d>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(B, A);
            const int32x4_t t1 = vornq_s32(t0, C);
            return t1;
        }
        ...
        // code=0x61, function=((not (B) or A) and (not (B) xor (A xor C))), lowered=((B notor A) and (not (B) xor (A xor C))), set=neon
        ...
        // code=0x63, function=(B xor (not (A) or C)), lowered=(B xor (A notor C)), set=neon
        ...
        // code=0x65, function=(C xor (not (A) or B)), lowered=(C xor (A notor B)), set=neon
        ...
        // code=0x67, function=((B xor C) or (A nor B)), lowered=((A or B) notor (B xor C)), set=optimized
        ...
        // code=0x6b, function=(((not (A) and C) and B) or (B xor (not (A) or C))), lowered=(((A notand C) and B) or (B xor (A notor C))), set=neon
        template<> int32x4_t ternary<0x6b>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(C, A);
            const int32x4_t t1 = vandq_s32(t0, B);
            const int32x4_t t2 = vornq_s32(C, A);
        ...
        // code=0x6d, function=(((not (C) and B) and A) or (A xor (not (C) or B))), lowered=(((C notand B) and A) or (A xor (C notor B))), set=neon
        template<> int32x4_t ternary<0x6d>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(B, C);
            const int32x4_t t1 = vandq_s32(t0, A);
            const int32x4_t t2 = vornq_s32(B, C);
            const int32x4_t t3 = veorq_s32(A, t2);
            const int32x4_t t4 = vorrq_s32(t1, t3);
            return t4;
        }
        ...
        // code=0x6f, function=(not (A) or (B xor C)), lowered=(A notor (B xor C)), set=neon
        ...
        // code=0x71, function=((B nor C) or (A and (B xor C))), lowered=((B or C) notor (A and (B xor C))), set=optimized
        ...
        // code=0x73, function=(not (B) or (A and not (C))), lowered=(B notor (C notand A)), set=optimized
        ...
        // code=0x75, function=(not (C) or (A and not (B))), lowered=(C notor (B notand A)), set=optimized
        ...
        // code=0x79, function=(((not (B) and A) and C) or (C xor (not (B) or A))), lowered=(((B notand A) and C) or (C xor (B notor A))), set=neon
        template<> int32x4_t ternary<0x79>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vbicq_s32(A, B);
            const int32x4_t t1 = vandq_s32(t0, C);
            const int32x4_t t2 = vornq_s32(A, B);
            const int32x4_t t3 = veorq_s32(C, t2);
            const int32x4_t t4 = vorrq_s32(t1, t3);
            return t4;
        }
        ...
        // code=0x7b, function=(not (B) or (A xor C)), lowered=(B notor (A xor C)), set=optimized
        ...
        // code=0x7d, function=(not (C) or (A xor B)), lowered=(C notor (A xor B)), set=neon
        ...
        // code=0x7f, function=(not ((A and C)) or (not (B) and A)), lowered=((A and C) notor (B notand A)), set=neon
        ...
        // code=0x81, function=(not ((A xor C)) and (A xor not (B))), lowered=((A xor C) notand (A xor not (B))), set=neon
        ...
        // code=0x83, function=(not ((A xor B)) and (not (A) or C)), lowered=((A xor B) notand (A notor C)), set=neon
        ...
        // code=0x85, function=(not ((A xor C)) and (not (C) or B)), lowered=((A xor C) notand (C notor B)), set=neon
        ...
        // code=0x89, function=(not ((B xor C)) and (not (A) or B)), lowered=((B xor C) notand (A notor B)), set=neon
        ...
        // code=0x8b, function=((not (A) or B) and (not (B) or C)), lowered=((A notor B) and (B notor C)), set=neon
        ...
        // code=0x8d, function=((not (C) or B) and (not (A) or C)), lowered=((C notor B) and (A notor C)), set=neon
        ...
        // code=0x8f, function=(not (A) or (B and C)), lowered=(A notor (B and C)), set=optimized
        ...
        // code=0x91, function=(not ((B xor C)) and (not (B) or A)), lowered=((B xor C) notand (B notor A)), set=neon
        ...
        // code=0x97, function=(((not (B) or A) xor A) or (A xor (B xor C))), lowered=(((B notor A) xor A) or (A xor (B xor C))), set=neon
        ...
        // code=0x9b, function=(not ((B xor C)) or (not (A) and C)), lowered=((B xor C) notor (A notand C)), set=neon
        ...
        // code=0x9d, function=(not ((B xor C)) or (not (A) and B)), lowered=((B xor C) notor (A notand B)), set=neon
        ...
        // code=0xa1, function=(not ((A xor C)) and (not (B) or A)), lowered=((A xor C) notand (B notor A)), set=neon
        ...
        // code=0xa3, function=((not (B) or A) and (not (A) or C)), lowered=((B notor A) and (A notor C)), set=neon
        ...
        // code=0xa7, function=(not ((A xor C)) or (not (B) and C)), lowered=((A xor C) notor (B notand C)), set=neon
        ...
        // code=0xab, function=(C or (B nor A)), lowered=((B or A) notor C), set=intel
        template<> int32x4_t ternary<0xab>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vorrq_s32(B, A);
            const int32x4_t t1 = vornq_s32(C, t0);
            return t1;
        }
        ...
        // code=0xad, function=(not ((A xor C)) or (B and C)), lowered=((A xor C) notor (B and C)), set=neon
        template<> int32x4_t ternary<0xad>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = veorq_s32(A, C);
            const int32x4_t t1 = vandq_s32(B, C);
            const int32x4_t t2 = vornq_s32(t1, t0);
            return t2;
        }
        ...
        // code=0xaf, function=(C or not (A)), lowered=(A notor C), set=intel
        ...
        // code=0xb1, function=((not (C) or A) and (not (B) or C)), lowered=((C notor A) and (B notor C)), set=neon
        ...
        // code=0xb3, function=(not (B) or (A and C)), lowered=(B notor (A and C)), set=optimized
        ...
        // code=0xb5, function=(not ((A xor C)) or (not (B) and A)), lowered=((A xor C) notor (B notand A)), set=neon
        ...
        // code=0xb9, function=((B xnor C) or (A and not (B))), lowered=((B xor C) notor (B notand A)), set=optimized
        ...
        // code=0xbb, function=(C or not (B)), lowered=(B notor C), set=intel
        ...
        // code=0xbd, function=(not ((A xor C)) or (A xor B)), lowered=((A xor C) notor (A xor B)), set=neon
        ...
        // code=0xbf, function=(C or (B nand A)), lowered=((B and A) notor C), set=intel
        ...
        // code=0xc1, function=(not ((A xor B)) and (not (C) or A)), lowered=((A xor B) notand (C notor A)), set=neon
        ...
        // code=0xc5, function=((not (C) or A) and (not (A) or B)), lowered=((C notor A) and (A notor B)), set=neon
        ...
        // code=0xc7, function=(not ((A xor B)) or (not (C) and B)), lowered=((A xor B) notor (C notand B)), set=neon
        ...
        // code=0xcb, function=(not ((A xor B)) or (B and C)), lowered=((A xor B) notor (B and C)), set=neon
        ...
        // code=0xcd, function=(B or (A nor C)), lowered=((A or C) notor B), set=intel
        template<> int32x4_t ternary<0xcd>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vorrq_s32(A, C);
            const int32x4_t t1 = vornq_s32(B, t0);
            return t1;
        }
        ...
        // code=0xcf, function=(B or not (A)), lowered=(A notor B), set=intel
        ...
        // code=0xd1, function=((B nor C) or (A and B)), lowered=((B or C) notor (A and B)), set=optimized
        ...
        // code=0xd3, function=(not ((A xor B)) or (not (C) and A)), lowered=((A xor B) notor (C notand A)), set=neon
        ...
        // code=0xd5, function=(not (C) or (A and B)), lowered=(C notor (A and B)), set=optimized
        ...
        // code=0xd9, function=((B xnor C) or (A and B)), lowered=((B xor C) notor (A and B)), set=optimized
        ...
        // code=0xdb, function=(not ((A xor B)) or (A xor C)), lowered=((A xor B) notor (A xor C)), set=neon
        ...
        // code=0xdd, function=(B or not (C)), lowered=(C notor B), set=intel
        ...
        // code=0xdf, function=(B or (A nand C)), lowered=((A and C) notor B), set=intel
        ...
        // code=0xe3, function=(not ((A xor B)) or (A and C)), lowered=((A xor B) notor (A and C)), set=neon
        template<> int32x4_t ternary<0xe3>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = veorq_s32(A, B);
            const int32x4_t t1 = vandq_s32(A, C);
            const int32x4_t t2 = vornq_s32(t1, t0);
            return t2;
        }
        ...
        // code=0xe5, function=(not ((A xor C)) or (A and B)), lowered=((A xor C) notor (A and B)), set=neon
        ...
        // code=0xe7, function=(not ((A xor B)) or (B xor C)), lowered=((A xor B) notor (B xor C)), set=neon
        ...
        template<> int32x4_t ternary<0xe9>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            ...
            const int32x4_t t1 = veorq_s32(B, C);
            const int32x4_t t2 = veorq_s32(t0, t1);
            const int32x4_t t3 = vandq_s32(A, B);
            const int32x4_t t4 = vorrq_s32(t2, t3);
            return t4;
        }
        ...
        // code=0xeb, function=(C or (B xnor A)), lowered=((B xor A) notor C), set=intel
        ...
        // code=0xed, function=(B or (A xnor C)), lowered=((A xor C) notor B), set=intel
        ...
        // code=0xef, function=(not (A) or (B or C)), lowered=(A notor (B or C)), set=optimized
        ...
        // code=0xf1, function=(A or (B nor C)), lowered=((B or C) notor A), set=intel
        template<> int32x4_t ternary<0xf1>(const int32x4_t A, const int32x4_t B, const int32x4_t C) {
            const int32x4_t t0 = vorrq_s32(B, C);
            const int32x4_t t1 = vornq_s32(A, t0);
            return t1;
        }
        ...
        // code=0xf3, function=(A or not (B)), lowered=(B notor A), set=intel
        ...
        // code=0xf5, function=(A or not (C)), lowered=(C notor A), set=intel
        ...
        // code=0xf7, function=(A or (B nand C)), lowered=((B and C) notor A), set=intel
        ...
        // code=0xf9, function=(A or (B xnor C)), lowered=((B xor C) notor A), set=intel
        ...
        // code=0xfb, function=(A or (not (B) or C)), lowered=(A or (B notor C)), set=optimized
        ...
        // code=0xfd, function=(not (C) or (A or B)), lowered=(C notor (A or B)), set=optimized
